...
void main() {
  ...
  group('Column/row resize at different zoom levels', () {
    // At 50% zoom (0.5):
    //   scaledHeaderWidth  = 50 * 0.5 = 25
    //   scaledHeaderHeight = 24 * 0.5 = 12
    //   scaledColumnWidth  = 100 * 0.5 = 50
    //   scaledRowHeight    = 24 * 0.5 = 12
    //
